...
// SparkLocal icon SVG paths (from sparklocal-icon.svg, scaled for OG image)
// These paths create the flame-pin mark logo
const ICON_PATHS = {
        ...
        children: [
          ...
          // Logo/Icon area
          {
            ...
            props: {
              ...
              children: [
                // SparkLocal flame-pin icon (scaled SVG)
                {
                  type: "svg",
                  props: {
                    width: 64,
